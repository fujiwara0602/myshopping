<?php
    ...
    $userId = $_SESSION['id']; // 実際のユーザーIDに置き換えてください
?>
...
<body>
    <div id="pagetop"><a href="#">Jump To Top</a></div>
                    ...
                    try {
                        ...
                        foreach ($cartProducts as $cartProduct) {
                            ...
                            <tr>
                                ...
                                <td class="button">
                                    <form method="POST" action="/file_delete/delete_confirm.php" onSubmit="return check()">
                                        <input type="hidden" name="cart_id" id="cart_id" value="<?= $cartProduct['cart_id'] ?>">
                                        <input type="hidden" name="product_id" id="product_id" value="<?= $cartProduct['product_id'] ?>">
                        ...
                        ?>
                        <tr>
                            <th colspan="2"><a href="cart.php"><button class="cart_button">カートに戻る</button></a></th>
                            <th colspan="2"><a href="complete.php"><button class="cart_button">購入確定</button></a></th>
                            <th></th>
                        </tr>
                        <?php
                        $pdo->commit();
        ...
        <footer id="footer">
        <?php include ( dirname(__FILE__) . '/commonfooter.php' ); ?>
        </footer>
    </body>
</html>
